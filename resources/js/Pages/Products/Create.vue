<template>
    ...
    <div>
        ...
        <form @submit.prevent="form.post('/product')">
            <div class="flex justify-center items-center mt-20 mb-0 items-center">
                ...
                <div class="col-span-2 flex justify-center mb-2 mt-2 items-center">
                ...
                <div class="col-span-2 flex justify-center mb-2 mt-2 items-center">
                    ...
                    <select class="input-error ml-5 mt-5 px-5 py-3 w-96 border border-gray-600 rounded" id="category" v-model="form.category_id">
                ...
                <div class="col-span-2 flex justify-center mb-2 mt-2 items-center ">
                    ...
                    <select class="input-error ml-5 mt-5 px-5 py-3 w-96 border border-gray-600 rounded" id="brand" v-model="form.brand_id">
                        <option class="" v-for="brand in brands" :key="brand.id" :value="brand.id">
                            {{ brand.name }}
                        </option>
