...
<template>
    <ActionSection>
        ...
        <template #description>
            Gerir e terminar as suas sessões ativas noutros navegadores e dispositivos.
        </template>

        <template #content>
            <div class="max-w-xl text-sm text-gray-600">
                Se necessário, pode terminar todas as suas outras sessões do navegador em todos os seus dispositivos. Algumas das suas sessões recentes estão listadas abaixo; no entanto, esta lista pode não ser exaustiva. Se achar que a sua conta foi comprometida, também deve atualizar a sua palavra-passe.
            </div>
            ...
            <div class="flex items-center mt-5">
                <PrimaryButton @click="confirmLogout">
                    Terminar Outras Sessões do Navegador
                </PrimaryButton>
            ...
            <!-- Modal de Confirmação para Terminar Outras Sessões -->
            <DialogModal :show="confirmingLogout" @close="closeModal">
                ...
                <template #content>
                    Por favor, insira a sua palavra-passe para confirmar que deseja terminar as suas outras sessões do navegador em todos os seus dispositivos.
